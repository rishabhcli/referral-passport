...
export const REPLAY_BLOCKED: RunStateModel = {
  ...
  intakeDecision: {
    decision: 'blocked',
    taskState: 'blocked',
    missingRequirements: ['uacr_recent'],
    satisfiedRequirements: baseRequirements.map(r => r.code),
  ...
  requirements: [
    ...baseRequirements,
    { code: 'uacr_recent', label: 'UACR within 90 days', status: 'unmet', description: 'Not found in patient chart — order/retrieve manually', required: true, repairable: true },
  ],
